...
> = {
  // The gold variant now sits on a LIGHT background: light text and a
  // barely-visible border used to disappear on paper. Full fill, white text.
  gold: {
...
/**
 * Action button (style from the prototype):
 *  • idle   → glass surface with a metallic border
 *  • hover  → metal "fills in" from the bottom, text inverts, hairline at the top
 *  • active → pressed state (scale + inset)
 */
